...
{
	/// <summary>Handling event fired after a PlayerMessage has been processed </summary>
	public delegate void MessageEventHandler(object sender, HearEventArgs arg);

	/// <summary>Delegate for time events.</summary>
